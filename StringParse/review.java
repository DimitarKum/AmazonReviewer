...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/fortune/F4P5WRYHE/review.java?nojsmode=1" /></noscript>
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
	    ...
	    <title>Review.java | Amazon Reviewer Slack</title>
	...
	<div id="site_nav_contents">
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/159036276416?crumb=s-1490563931-583b716433-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
...
<p class="print_only">
	...
	<span class="subtle_silver break_word">https://amazonreviewer.slack.com/files/fortune/F4P5WRYHE/review.java</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T4P1284C8-F4P5WRYHE-b4d1e2eb05" target="new">https://slack-files.com/T4P1284C8-F4P5WRYHE-b4d1e2eb05</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<p class="small subtle_silver no_print meta">
		...
		1KB Java snippet created on <span class="date">March 26, 2017</span>.
...
public class Review /*implements Comparable&lt;Review&gt;*/ {
	private final /*int[]*/JSONArray helpful;
	private final String review;
	private final double rating;
	
	public Review(final JSONObject json/*final int[] theHelpful, final String theReview, final double theRating*/) {
		helpful = (JSONArray) json.get(&quot;helpful&quot;);//theHelpful;
		review = (String) json.get(&quot;reviewText&quot;);//theReview;
		rating = (Double) json.get(&quot;overall&quot;);//theRating;
	}
	...
	public String toString() {
		return &quot;Rating: &quot; + rating + &quot;\n&quot; + &quot;Review: &quot; + review + &quot;\n&quot; + &quot;Helpfulness: &quot; + helpful.get(0) + &quot;/&quot; + helpful.get(1);
	}
	
//	@Override
//	public int compareTo(Review other) {
//		return (int) other.rating - (int) this.rating;
//	}
...
<form action="https://amazonreviewer.slack.com/files/fortune/F4P5WRYHE/review.java"
	...
	<input type="hidden" name="crumb" value="s-1490563931-f9ae8d56ab-☃" />
...
<script type="text/javascript" src="https://a.slack-edge.com/8909/js/codemirror_load.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F4P5WRYHE","created":1490563842,"timestamp":1490563842,"name":"Review.java","title":"Review.java","mimetype":"text\/plain","filetype":"java","pretty_type":"Java","user":"U4QCH38UE","editable":true,"size":1016,"mode":"snippet","is_external":false,"external_type":"","is_public":true,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T4P1284C8-F4P5WRYHE\/review.java","url_private_download":"https:\/\/files.slack.com\/files-pri\/T4P1284C8-F4P5WRYHE\/download\/review.java","permalink":"https:\/\/amazonreviewer.slack.com\/files\/fortune\/F4P5WRYHE\/review.java","permalink_public":"https:\/\/slack-files.com\/T4P1284C8-F4P5WRYHE-b4d1e2eb05","edit_link":"https:\/\/amazonreviewer.slack.com\/files\/fortune\/F4P5WRYHE\/review.java\/edit","preview":"package learnWatson.watson3;\r\n\r\n\r\nimport org.json.simple.JSONArray;\r\nimport org.json.simple.JSONObject;\r","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Epackage\u003C\/span\u003E \u003Cspan class=\"cm-def\"\u003ElearnWatson\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Ewatson3\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Eorg\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Ejson\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Esimple\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003EJSONArray\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Eorg\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Ejson\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Esimple\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003EJSONObject\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":40,"lines_more":35,"preview_is_truncated":false,"channels":["C4QCG8GA2"],"groups":[],"ims":[],"comments_count":0};
...
<!-- slack-www-hhvm-0614adaa092fb06cc / 2017-03-26 14:32:11 / v7a2e208eddb3d791479c41a3858afd17f15ec37a / B:H -->
