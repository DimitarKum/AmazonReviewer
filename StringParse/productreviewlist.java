...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/fortune/F4P5WRTH6/productreviewlist.java?nojsmode=1" /></noscript>
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
	    ...
	    <title>ProductReviewList.java | Amazon Reviewer Slack</title>
	...
	<div id="site_nav_contents">
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/159036276416?crumb=s-1490563927-ea4cfadffb-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
...
<p class="print_only">
	...
	<span class="subtle_silver break_word">https://amazonreviewer.slack.com/files/fortune/F4P5WRTH6/productreviewlist.java</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T4P1284C8-F4P5WRTH6-7402093ba6" target="new">https://slack-files.com/T4P1284C8-F4P5WRTH6-7402093ba6</a>
</div></div>
...
public class ProductReviewList {
	...
	private final HashSet&lt;Review&gt; reviewsList;
	private final ArrayList&lt;JSONObject&gt; jsonList;
	
	public ProductReviewList(ArrayList&lt;JSONObject&gt; theJsonList, String theID) {
		reviewsList = new HashSet&lt;Review&gt;();
		jsonList = theJsonList;
		productID = theID;
		createList();
	}
	...
	private void createList() {
		for (JSONObject json : jsonList) {
			String jsonID = (String) json.get(&quot;asin&quot;);
	...
	public ArrayList&lt;String&gt; getReviewsTxt() {
		ArrayList&lt;String&gt; list = new ArrayList&lt;String&gt;();
		for (Review rev : reviewsList) {
			list.add(rev.getReview());
		}
		return list;
	}
...
<form action="https://amazonreviewer.slack.com/files/fortune/F4P5WRTH6/productreviewlist.java"
	...
	<input type="hidden" name="crumb" value="s-1490563927-7516b12b8b-☃" />
...
<script type="text/javascript" src="https://a.slack-edge.com/8909/js/codemirror_load.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F4P5WRTH6","created":1490563839,"timestamp":1490563839,"name":"ProductReviewList.java","title":"ProductReviewList.java","mimetype":"text\/plain","filetype":"java","pretty_type":"Java","user":"U4QCH38UE","editable":true,"size":1367,"mode":"snippet","is_external":false,"external_type":"","is_public":true,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T4P1284C8-F4P5WRTH6\/productreviewlist.java","url_private_download":"https:\/\/files.slack.com\/files-pri\/T4P1284C8-F4P5WRTH6\/download\/productreviewlist.java","permalink":"https:\/\/amazonreviewer.slack.com\/files\/fortune\/F4P5WRTH6\/productreviewlist.java","permalink_public":"https:\/\/slack-files.com\/T4P1284C8-F4P5WRTH6-7402093ba6","edit_link":"https:\/\/amazonreviewer.slack.com\/files\/fortune\/F4P5WRTH6\/productreviewlist.java\/edit","preview":"package learnWatson.watson3;\r\n\r\n\r\nimport java.util.ArrayList;\r\nimport java.util.HashSet;\r","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Epackage\u003C\/span\u003E \u003Cspan class=\"cm-def\"\u003ElearnWatson\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Ewatson3\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Ejava\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Eutil\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003EArrayList\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Ejava\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Eutil\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003EHashSet\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":62,"lines_more":57,"preview_is_truncated":true,"channels":["C4QCG8GA2"],"groups":[],"ims":[],"comments_count":0};
...
<!-- slack-www-hhvm-008308f92b9daab64 / 2017-03-26 14:32:07 / v7a2e208eddb3d791479c41a3858afd17f15ec37a / B:H -->
